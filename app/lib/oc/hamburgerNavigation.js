...
function hamburgernavigation() {
    ...
    function template() {
        return [
            ...
            '</li>',
            //orders
            '<li id="orders" ng-show="user.Type == \'Customer\'">',
            '<nav class="navbar-orders" role="navigation">',
            '<div>',
            '<a ng-click="isCollapsedOrders = !isCollapsedOrders">',
            '<i class="fa fa-file" ng-show="isCollapsedOrders"></i>',
            '<i class="fa fa-file-text" ng-show="!isCollapsedOrders"></i>',
            '<span>{{\'Orders\' | r | xlat}}</span>',
            '</a>',
            '</div>',
            '</nav>',
            '<div class="col-xs-12 col-collapse" collapse="isCollapsedOrders">',
            '<ul class="navbar-nav orders">',
            '<li>',
            '<a ng-click="retarget(\'order\')">',
            '<i class="fa fa-clipboard"></i>',
            '{{\'Order History\' | r | xlat}}',
            '</a>',
            '</li>',
            '<li>',
            ...
            '</li>',
            '<li>',
            '<a href="#" neworder ng-show="user.Permissions.contains(\'MultipleShoppingCart\') && currentOrder" ng-click="newOrderLoadingIndicator = true;startNewOrder()">',
